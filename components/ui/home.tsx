      ...
      <div className='flex flex-col lg:flex-row items-center justify-between w-full px-8 lg:px-16'>
        ...
        <div className='flex flex-col items-start lg:w-1/2'>
          ...
          <div className='flex space-x-4 py-4'>
            ...
            <button className='px-1 rounded-full bg-transparent bg-gradient-to-br from-yellow-200 to-green-300 text-white transition transform hover:translate-y-1' onClick={() => window.location.href = 'https://drive.google.com/file/d/12nj29EDjHHfK8kABwBQNhCUV0Hh0KCsq/view?usp=sharing'}>
